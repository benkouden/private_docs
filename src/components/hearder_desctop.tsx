...
const Hearder_desctop = () => {
  ...
  return (
    <header className="flex justify-between items-center mb-8">
          <h1 className="w-[250px] h-[32px] font-Urbanist text-text text-[30px]  leading-[32px] tracking-[-0.25px]
             font-medium">Bienvenue, Ken B.
         </h1>
          <div className="relative flex gap-x-2">
             <Image src={Notification} alt="item5" className=" border rounded-xl h-10 w-10 p-1 border-bg_2  " />
             <Image
              src={Avatar}
              alt="User profile"
              width={70}
